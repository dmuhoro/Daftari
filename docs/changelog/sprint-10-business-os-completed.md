# Sprint 10 — Daftari Business OS v2.0: Edit/Delete, Search, Monthly P&L, CSV Export, Customer 360°, Fuliza Tracking
...
- [x] `docs/changelog/sprint-10-business-os-completed.md` created
