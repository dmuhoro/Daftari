# Sprint 11 — Multi-Business, Product Profitability & Supabase Restore (v3.0.0)
...
### Product Profitability (Option 1)
...
### Supabase Restore & Multi-Device Sync (Option 3)
...
- `docs/changelog/sprint-11-business-os-completed.md`
...
## Dependencies
- Sprint 10 (v2.0.0) — edit/delete, search, monthly P&L, CSV, customer 360°, Fuliza
